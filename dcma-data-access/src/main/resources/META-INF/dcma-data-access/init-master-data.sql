...
INSERT INTO plugin(id,creation_date,last_modified,plugin_name,plugin_desc,plugin_version,workflow_name) VALUES (12,now(),now(),'RECOSTAR_HOCR','Recostar plugin','1.0.0.0','Recostar_HOCR_Generation_Plugin');
...
INSERT INTO plugin(id,creation_date,last_modified,plugin_name,plugin_desc,plugin_version,workflow_name) VALUES (21,now(),now(),'RECOSTAR_EXTRACTION','Recostar Extraction Plugin','1.0.0.0','Recostar_Doc_Fields_Extraction_Plugin');
...
INSERT INTO plugin_config(id,creation_date,last_modified,config_datatype,config_desc,config_multivalue,config_name,plugin_id) VALUES (33,now(),now(),'STRING','Recostar Valid Extensions',1,'recostar.valid_extensions',null);
INSERT INTO plugin_config(id,creation_date,last_modified,config_datatype,config_desc,config_multivalue,config_name,plugin_id) VALUES (34,now(),now(),'STRING','Recostar Project File Name',0,'recostar.project_file',null);
...
INSERT INTO plugin_config_sample_value(id,creation_date,last_modified,sample_value,plugin_config_id) VALUES (40,now(),now(),'tif',33);
INSERT INTO plugin_config_sample_value(id,creation_date,last_modified,sample_value,plugin_config_id) VALUES (41,now(),now(),'gif',33);
INSERT INTO plugin_config_sample_value(id,creation_date,last_modified,sample_value,plugin_config_id) VALUES (42,now(),now(),'Fpr.rsp',34);
